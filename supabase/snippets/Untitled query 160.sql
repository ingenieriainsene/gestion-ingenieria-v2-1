...
CREATE TABLE IF NOT EXISTS presupuesto_lineas (
    id_linea UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
BEGIN
  IF EXISTS (
      ...
      IF EXISTS (
          ...
          WHERE c.relname = 'presupuesto_lineas'
            AND a.attname = 'id_linea'
            AND a.attidentity <> ''
      ) THEN
          EXECUTE 'ALTER TABLE presupuesto_lineas ALTER COLUMN id_linea DROP IDENTITY';
      END IF;
      ALTER TABLE presupuesto_lineas ALTER COLUMN id_linea DROP DEFAULT;
      ALTER TABLE presupuesto_lineas ALTER COLUMN id_linea TYPE UUID USING gen_random_uuid();
      ALTER TABLE presupuesto_lineas ALTER COLUMN id_linea SET DEFAULT gen_random_uuid();
      ALTER TABLE presupuesto_lineas ADD PRIMARY KEY (id_linea);
  END IF;
END $$;
