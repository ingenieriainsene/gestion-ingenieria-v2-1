...
CROSS JOIN cap
CROSS JOIN (VALUES
  (1, 'Limpieza de módulos FV', 1, 2, 400.00, 1.00, 400.00, 400.00, 400.00, 84.00, 484.00, 21, 400.00, 400.00, '01.01'),
  (2, 'Revisión de inversores', 1, 1, 350.00, 1.00, 350.00, 350.00, 350.00, 73.50, 423.50, 21, 350.00, 350.00, '01.02'),
  (3, 'Termografía de cuadros DC/AC', 1, 1, 500.00, 1.00, 500.00, 500.00, 500.00, 105.00, 605.00, 21, 500.00, 500.00, '01.03'),
  (4, 'Inspección de estructura y anclajes', 1, 1, 250.00, 1.00, 250.00, 250.00, 250.00, 52.50, 302.50, 21, 250.00, 250.00, '01.04'),
  (5, 'Verificación de protecciones', 1, 1, 200.00, 1.00, 200.00, 200.00, 200.00, 42.00, 242.00, 21, 200.00, 200.00, '01.05'),
  (6, 'Revisión de monitorización', 1, 1, 180.00, 1.00, 180.00, 180.00, 180.00, 37.80, 217.80, 21, 180.00, 180.00, '01.06')
) AS v(
  orden, concepto, cantidad, num_visitas, coste_unitario, factor_margen, total_coste, pvp_unitario, total_pvp,
  importe_iva, total_final, iva_porcentaje, precio_unitario, total_linea, codigo_visual
);
...
DROP INDEX IF EXISTS uq_alb_venta_presupuesto;
...
DROP INDEX IF EXISTS uq_fac_venta_presupuesto;

-- Asegurar que las columnas de relación con presupuesto
-- permiten valores NULL (necesario para documentos de venta manuales)
...
-- 1.16 LEGALIZACIONES BT (HISTORIAL PERSISTENTE)
